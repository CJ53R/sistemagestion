...
@section('title', 'Editar Permisos de Rol')
...
<section class="higher py-3 bg-lig">
    <div class="container">
      <div class="row">
        <div class="col-lg-9">
          <h1 class="fw-bold mb-0">Bienvenido al Panel de Edición de Rol</h1>
    ...
    <div class="container">
       <div class="card">
        <div class="form-group col-12 text-center mt-4">
          ...
          <form action="{{route('admin.role.update', $role)}}" method="POST" id="formulario">
            @csrf
            @method('put')
            <div class="card-body">
              <div class="row">
                <div class="form-group col-12 mb-3">
                  <div class="contdiv" id="group_name">
                    <label>
                      ...
                      <input type="text" autocomplete="off" name="name" value="{{$role->name}}" id="name" onpaste="return false">
                ...
                @foreach ($permissions as $permission)
                    <div class="col col-lg-3 col-md-4 col-sm-6 col-12 my-1 fw-bold">
                        {!! Form::checkbox('permissions[]', $permission->id,($role->permissions->contains($permission->id)), ['class' => 'mr-1', 'id' => $permission->id]) !!}
                ...
                <div class="form-group col-12 mb-3 text-center">
                  <button class="button fw-bold align-self-center my-2" type="submit">Editar Permisos</button>
                </div>
                @endcan
              </div>
            </div>
...
@section('script')
  ...
  @if (session('info')=='ok')
    <script>
      swal({
                title: "¡Bien!",
                text: "¡Editó Correctamente los Permisos del Rol!",
                icon: "success",
                button: "OK!",
              });
    </script>
