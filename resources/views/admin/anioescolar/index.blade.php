...
@section('title', 'Lista de Grados y Horarios')
...
@section('content')
  <section class="higher py-3 bg-lig">
    <div class="container">
      <div class="row">
        <div class="col-lg-9">
          <h1 class="fw-bold mb-0">Bienvenido al Panel de Horarios</h1>
          <p class="lead text-muted">Usa el buscador para búsquedas más precisas</p>
        </div>
        @can('admin.anioescolar.create')
        <div class="col-lg-3 d-flex">
          <a class="btn button fw-bold align-self-center" href="{{route('admin.anioescolar.create')}}">Registrar Nuevo Horario</a>
        </div>
        @endcan
      </div>
    </div>
...
$('.estudiante').DataTable({
  ...
  responsive: true,
  autoWidth: false, 
  ajax: "{{asset(route('admin.anioescolar.showDataAnioescolarList'))}}",
  dataType: 'json',
  type: "POST",
  columns: [
    {data: 'id', name: 'id'},
    {data: 'nombre', name: 'nombre'},
    {data: 'nombrenivel', name: 'nombrenivel'},
