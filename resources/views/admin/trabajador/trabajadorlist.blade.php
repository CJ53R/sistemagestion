...
@section('content')
  <section class="higher pt-3 bg-lig">
    <div class="container">
      <div class="row">
        <div class="col-lg-9">
          <h1 class="fw-bold mb-0">Bienvenido al panel de lista de Trabajadores</h1>
          <p class="lead text-muted">Usa el buscador para búsquedas más precisas</p>
        </div>
        @can('admin.trabajador.create')
        <div class="col-lg-3 d-flex">
          <a class="btn button fw-bold align-self-center" href="{{route('admin.trabajador.create')}}">Registrar Nuevo Trabajador</a>
        </div>
        @endcan
      </div>
    </div>
...
$('.estudiante').DataTable({
  ...
  responsive: true,
  autoWidth: false, 
  ajax: "{{asset(route('admin.trabajador.showDataTrabajadorList'))}}",
  dataType: 'json',
  type: "POST",
  columns: [
    {data: 'id', name: 'id'},
    {data: 'numDocumento', name: 'numDocumento'},
    {data: 'name', name: 'name'},
    {data: 'nombregenero', name: 'nombregenero'},
