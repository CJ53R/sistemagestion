...
@section('title', 'Imagenes de Infraestructura')
...
<section class="higher py-3 bg-lig">
    <div class="container">
      <div class="row">
        <div class="col-lg-9">
          <h1 class="fw-bold mb-0">Bienvenido al Panel de Creación de de Imagenes de Infraetructura</h1>
...
<section class="bg-mix mb-4">
    <div class="container">
       <div class="card">
        <div class="form-group col-12 text-center mt-4">
          ...
          <form action="{{route('admin.infraestructura.storeinfraestructura')}}" method="POST" id="formulario" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="col-lg-12">
                ...
                @can('admin.infraestructura.storeinfraestructura')
    ...
    <div class="container mb-4">
      <div class="card mt-4">
        ...
        <div class="card-body">
          <div class="row">
            @foreach ($imagenes as $infraestructura)
              <div class="col col-lg-4 mt-4">
                <form action="{{route('admin.infraestructura.destroy', $infraestructura)}}" class="{{$infraestructura->id}}" method="POST">
                  @csrf
                  @method('DELETE')
                  <div class="imgnoticia">
                    <img src="{{asset($infraestructura->url)}}"> 
                  </div>
                  <div class="img-button text-center">
                    <button class="button fw-bold align-self-center btn-delete" type="submit" id="{{$infraestructura->id}}">Eliminar</button>
                  </div>
                </form>
              </div>
            @endforeach
