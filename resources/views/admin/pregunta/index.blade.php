...
@section('content')
  <section class="higher py-3 bg-lig">
    <div class="container">
      <div class="row">
        <div class="col-lg-9">
          <h1 class="fw-bold mb-0">Bienvenido al Panel de Lista de Preguntas Frecuentes</h1>
          <p class="lead text-muted">Usa el buscador para búsquedas más precisas</p>
        </div>
        @can('admin.pregunta.create')
        <div class="col-lg-3 d-flex">
          <a class="btn button fw-bold align-self-center" href="{{route('admin.pregunta.create')}}">Registrar Nueva Pregunta</a>
        </div>
        @endcan
      </div>
    </div>
...
$('.estudiante').DataTable({
  ...
  responsive: true,
  autoWidth: false, 
  ajax: "{{asset(route('admin.pregunta.showDataPreguntaList'))}}",
  dataType: 'json',
  type: "POST",
  columns: [
    {data: 'id', name: 'id'},
