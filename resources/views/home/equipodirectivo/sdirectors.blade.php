...
@section('title', 'Sub Dirección Secundaria')
    ...
    <div class="container">
        <div class="row justify-content-center cont">
          ...
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            <h3 class="fw-bold t-principal">SUB DIRECCION DE SECUNDARIA</h3>
          </div>
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
              <div class="contenedor-text">
                ...
                <p>Liderar y orientar el proceso de enseñanza y aprendizaje del nivel(es) y/o modalidad a su cargo, asignado por el director, 
                  así como la identificación de necesidades y gestión de recursos educativos, a fin de promover la mejora del nivel(es) y/o 
                  modalidad a su cargo, garantizando la integridad físico-emocional de todos los estudiantes, el respeto a la diversidad y la 
                  mejora de los aprendizajes, en el marco del Currículo Nacional de Educación Básica o los Lineamientos Académicos Generales para 
                  los Centros de Educación Técnico Productiva, según corresponda.</p>        
              </div>
            </div>
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
              <div class="contenedor-text">
